namespace RiotApi.DataStructures.LeagueOfLegends
{
    ...
    public class ParticipantDto
    {
        ...
        public int NeutralMinionsKillde { get; set; }
        public int NexusKills { get; set; }
        public int NexusTakedowns { get; set; }
        public int NexusLost { get; set; }
        public int ObjectiveStolen { get; set; }
        public int ObjectiveStolenAssits { get; set; }
        ...
        public int TotalUnitsHeald { get; set; }
        public int TripleKills { get; set; }
        public int TrueDamageDealt { get; set; }
        public int TrueDamageDealtToChampions { get; set; }
        public int TurrentKills { get; set; }
        public int TurrentTakedowns { get; set; }
        public int TurrentsLost { get; set; }
